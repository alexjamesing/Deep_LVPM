...
class SiameseBarlow(tf.keras.Model):
    ...
    def train_step(self, inputs):
        ...
        for vie in range(len(self.model_list)):
            ...
            with tf.GradientTape() as tape:
                ...
                mse_loss = self.mse_loss(y_true, y_pred,tf.cast(tf.shape(y_pred)[0], dtype=float))
    ...
    def mse_loss(self, y_true, y_pred, N, lambda_param=1e-4):
