...
# Build the shared encoder used by both branches of the DLVPM model.
WEIGHT_DECAY = 0
NDIMS = 256
...
def remove_last_layers(model: keras.Model, n: int = 1, name=None) -> keras.Model:
...
test_metrics = dlvpm_model.evaluate(test_ds, return_dict=True)
