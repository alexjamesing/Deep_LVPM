...
class ConfoundLayer(tf.keras.layers.Layer):
    ...
    def build(self, input_shape):
        ...
        self.batch_norm1 = tf.keras.layers.BatchNormalization(name = "batch_norm1_confound")
        self.batch_norm2 = tf.keras.layers.BatchNormalization(name = "batch_norm2_confound")
