...
# Installing deep-lvpm (keras 3 / multi-backend) — dev branch

> **TL;DR:** This branch uses **Keras 3** (multi-backend). You must install **one backend** (TensorFlow **or** PyTorch) via the provided extras. Then install from the **`dev`** branch URL.
...
```bash
pip install "git+https://github.com/alexjamesing/Deep_LVPM.git@dev#egg=deep-lvpm[tf-cpu]"
```

**NVIDIA GPU (Linux, bundled CUDA):**
```bash
pip install "git+https://github.com/alexjamesing/Deep_LVPM.git@dev#egg=deep-lvpm[tf-gpu]"
```

**Apple Silicon (M-series):**
```bash
pip install "git+https://github.com/alexjamesing/Deep_LVPM.git@dev#egg=deep-lvpm[tf-apple]"
```
...
```bash
pip install "git+https://github.com/alexjamesing/Deep_LVPM.git@dev#egg=deep-lvpm[torch-cpu]"
```

**Apple Silicon (M-series):**
```bash
pip install "git+https://github.com/alexjamesing/Deep_LVPM.git@dev#egg=deep-lvpm[torch-apple]"
```
...
pip install "git+https://github.com/alexjamesing/Deep_LVPM.git@dev#egg=deep-lvpm[torch-gpu]"
```
